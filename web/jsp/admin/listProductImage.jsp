        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach items="${topImages}" var="ti" varStatus="vs">
                <tr>
                    ...
                    <td><img src="http://localhost:8080/S_mall_servlet_master_war_exploded/pictures/product/${ti.id}.jpg" height="50px"></td>
    ...
    <div class="container" style="width:50%;float:left">
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach items="${detailImages}" var="ti" varStatus="vs">
                <tr>
                    <th scope="row">${ti.id}</th>
                    <td><img src="/img/product/${ti.id}.jpg" height="50px"></td>
                    <td><a href="productImage_delete?piid=${ti.id}&pid=${product.id}" class="delete-button"><span
                            class="glyphicon glyphicon-trash">删除</span></a></td>
                </tr>
            </c:forEach>
